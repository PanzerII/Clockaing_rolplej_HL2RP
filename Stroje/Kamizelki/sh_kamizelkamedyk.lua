...
ITEM.name = "Kamizelka Medyka"
ITEM.description = "Kamizelka Oficera MPF, z namalowan¹ Lambd¹ i czerwonym krzy¿em na plecach."
ITEM.category = "Ubrania"
ITEM.model = "models/fty/items/shirt_rebelmetrocop.mdl"
ITEM.width = 2
ITEM.height = 2
