...
ITEM.name = "Kevlar OTA"
ITEM.description = "Kevlar wyrwany z pancerza OTA. Jest ona ciê¿ka, aczkolwiek zapewnia dobr¹ ochronêprzed pociskami."
ITEM.category = "Ubrania"
ITEM.model = "models/fty/items/rebel_overwatch.mdl"
ITEM.width = 2
ITEM.height = 4
ITEM.outfitCategory = "Pancerz"
ITEM.pacData = {}
ITEM.bodyGroups = {
    ["kevlar"] = 4, }
ITEM.armor = 60
