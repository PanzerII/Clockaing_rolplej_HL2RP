...
ITEM.name = "Pancerz MOLLE"
ITEM.description = "Kamizelka MOLLE. Jest ona lekka i zapewnia œredni¹ ochronê przed pociskami."
ITEM.category = "Ubrania"
ITEM.model = "models/fty/items/shirt_rebel_molle.mdl"
ITEM.width = 2
ITEM.height = 3
